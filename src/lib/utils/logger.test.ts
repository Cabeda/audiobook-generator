...
describe('Logger', () => {
  ...
  describe('remote logging', () => {
    ...
    it('should not send to backend when sendToBackend is false', async () => {
      logger.configure({
        level: 'error',
        silent: false,
        sendToBackend: false,
    ...
    it('should send errors to backend when enabled', async () => {
    ...
    it('should send warnings to backend when enabled', async () => {
      ;(global.fetch as ReturnType<typeof vi.fn>).mockResolvedValue({
        ok: true,
      })
    ...
    it('should not send info messages to backend', async () => {
      ;(global.fetch as ReturnType<typeof vi.fn>).mockResolvedValue({
        ok: true,
      })
